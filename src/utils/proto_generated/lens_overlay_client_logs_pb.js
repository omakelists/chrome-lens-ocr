...
proto.lens.LensOverlayClientLogs.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    lensOverlayEntryPoint: jspb.Message.getFieldWithDefault(msg, 2, 0),
    paellaId: jspb.Message.getFieldWithDefault(msg, 3, 0),
    metricsCollectionDisabled: jspb.Message.getBooleanFieldWithDefault(msg, 5, false)
  };
